...
void OnTick(void)
{
    ...
    ObjectCreate(0, "support", OBJ_HLINE, 0, iTime(Symbol(), PERIOD_CURRENT, 0), support);
    double resistance = FindNearestAbove(currentPrice);
    ObjectCreate(0, "resistance", OBJ_HLINE, 0, iTime(Symbol(), PERIOD_CURRENT, 0), resistance);
